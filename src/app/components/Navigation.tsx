...
export function Navigation({ onContactClick }: NavigationProps) {
  ...
  return (
    <nav aria-label="Main navigation" className="fixed top-0 left-0 right-0 bg-white shadow-md z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-22">
          {/* Logo */}
          <div className="flex-shrink-0 flex items-center gap-3">
            <img src={logo} alt="Abbshir Fodder Trading logo" className="h-19 w-auto" />
            <span className="text-2xl font-bold text-emerald-700" aria-label="Abbshir Fodders – أبشر للأعلاف">
